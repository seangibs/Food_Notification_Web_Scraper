...
app.layout = dbc.Container([
    ...
    dbc.Row(
        dbc.Col(html.H1("EU Food Notifications",
...
def delete_data(delete_db):
    ...
    """
    Delete DB is commented here in case the functionality is accidently used and then all data is lost
    The Delete DB functionality can be used on a different identical script with just a different DB
    """
    # if delete_db:
    #     task_output = "Retrieving"
...
def truncate_data(truncate_db):
    task_output = ""
    """
    Truncate DB is commented here in case the functionality is accidently used and then all data is lost
    The Truncate DB functionality can be used on a different identical script with just a different DB
    """
    # if truncate_db:
